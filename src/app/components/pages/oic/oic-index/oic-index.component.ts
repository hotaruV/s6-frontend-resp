...
@Component({
  selector: 'app-oic-index',
  templateUrl: './oic-index.component.html',
  styleUrls: ['./oic-index.component.scss']
})
export class OicIndexComponent implements OnInit {
  ...
  openmodal() {
    this.modal.openDialogNotifications({
      title: this.ModalTitle,
      content: this.usuarioNotificacion
    });
  }
