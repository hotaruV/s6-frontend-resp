...
import { ListHitosLicitacionComponent } from './list-hitos-licitacion/list-hitos-licitacion.component';
interface Format {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-hitos-licitacion',
  templateUrl: './hitos-licitacion.component.html',
  styleUrls: ['./hitos-licitacion.component.scss']
})
export class HitosLicitacionComponent implements OnInit {
...
VerHito(): void {
  ...
  const dialogRef = this._modelService.open(ListHitosLicitacionComponent, {
    disableClose:true,
    autoFocus:true,
     width: '100%',
     height:'80%',
