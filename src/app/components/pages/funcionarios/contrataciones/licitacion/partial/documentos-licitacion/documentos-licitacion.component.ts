...
import { ListDocumentosLicitacionComponent } from './list-documentos-licitacion/list-documentos-licitacion.component';
...
@Component({
  selector: 'app-documentos-licitacion',
  templateUrl: './documentos-licitacion.component.html',
  styleUrls: ['./documentos-licitacion.component.scss']
})
export class DocumentosLicitacionComponent implements OnInit {
 ...
 VerDoc(): void {
  ...
  const dialogRef = this._modelService.open(ListDocumentosLicitacionComponent, {
    disableClose:true,
    autoFocus:true,
     width: '100%',
     height:'80%',
