...
@Component({
  selector: 'app-list-licitantes',
  templateUrl: './list-licitantes.component.html',
  styleUrls: ['./list-licitantes.component.scss']
})
export class ListLicitantesComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListLicitantesComponent>, private usrServ: UsuarioService,
