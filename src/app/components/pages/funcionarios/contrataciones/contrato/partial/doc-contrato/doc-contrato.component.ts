...
import { ListDocContratoComponent } from './list-doc-contrato/list-doc-contrato.component';
...
@Component({
  selector: 'app-doc-contrato',
  templateUrl: './doc-contrato.component.html',
  styleUrls: ['./doc-contrato.component.scss']
})
export class DocContratoComponent implements OnInit {
 ...
 VerDoc(): void {
  ...
  const dialogRef = this._modelService.open(ListDocContratoComponent, {
    disableClose:true,
    autoFocus:true,
     width: '100%',
     height:'80%',
