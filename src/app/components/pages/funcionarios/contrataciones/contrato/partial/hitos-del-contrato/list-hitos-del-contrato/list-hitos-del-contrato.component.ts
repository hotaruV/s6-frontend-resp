...
@Component({
  selector: 'app-list-hitos-del-contrato',
  templateUrl: './list-hitos-del-contrato.component.html',
  styleUrls: ['./list-hitos-del-contrato.component.scss']
})
export class ListHitosDelContratoComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListHitosDelContratoComponent>, private usrServ: UsuarioService,
