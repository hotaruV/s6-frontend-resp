...
import { ListHitosDelContratoComponent } from './list-hitos-del-contrato/list-hitos-del-contrato.component';
interface Format {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-hitos-del-contrato',
  templateUrl: './hitos-del-contrato.component.html',
  styleUrls: ['./hitos-del-contrato.component.scss']
})
export class HitosDelContratoComponent implements OnInit {
...
VerHito(): void {
  ...
  const dialogRef = this._modelService.open(ListHitosDelContratoComponent, {
    disableClose:true,
    autoFocus:true,
     width: '100%',
     height:'80%',
