...
@Component({
  selector: 'app-list-hitos-contrato',
  templateUrl: './list-hitos-contrato.component.html',
  styleUrls: ['./list-hitos-contrato.component.scss']
})
export class ListHitosContratoComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListHitosContratoComponent>, private usrServ: UsuarioService,
