...
@Component({
  selector: 'app-list-doc-contrato',
  templateUrl: './list-doc-contrato.component.html',
  styleUrls: ['./list-doc-contrato.component.scss']
})
export class ListDocContratoComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListDocContratoComponent>, private usrServ: UsuarioService,
