...
import { ListDocumentosContratoComponent } from './list-documentos-contrato/list-documentos-contrato.component';
...
@Component({
  selector: 'app-documentos-contrato',
  templateUrl: './documentos-contrato.component.html',
  styleUrls: ['./documentos-contrato.component.scss']
})
export class DocumentosContratoComponent implements OnInit {
 ...
 VerDoc(): void {
  ...
  const dialogRef = this._modelService.open(ListDocumentosContratoComponent, {
    disableClose:true,
    autoFocus:true,
     width: '100%',
     height:'80%',
