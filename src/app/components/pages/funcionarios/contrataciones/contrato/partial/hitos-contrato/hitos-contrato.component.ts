...
import { ListHitosContratoComponent } from './list-hitos-contrato/list-hitos-contrato.component';
interface Format {
  value: string;
  viewValue: string;
}
...
@Component({
  selector: 'app-hitos-contrato',
  templateUrl: './hitos-contrato.component.html',
  styleUrls: ['./hitos-contrato.component.scss']
})
export class HitosContratoComponent implements OnInit {
...
VerHito(): void {
  ...
  const dialogRef = this._modelService.open(ListHitosContratoComponent, {
    disableClose:true,
    autoFocus:true,
     width: '100%',
     height:'80%',
