...
@Component({
  selector: 'app-list-items-contrato',
  templateUrl: './list-items-contrato.component.html',
  styleUrls: ['./list-items-contrato.component.scss']
})
export class ListItemsContratoComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListItemsContratoComponent>, private usrServ: UsuarioService,
