...
@Component({
  selector: 'app-list-documentos-contrato',
  templateUrl: './list-documentos-contrato.component.html',
  styleUrls: ['./list-documentos-contrato.component.scss']
})
export class ListDocumentosContratoComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListDocumentosContratoComponent>, private usrServ: UsuarioService,
