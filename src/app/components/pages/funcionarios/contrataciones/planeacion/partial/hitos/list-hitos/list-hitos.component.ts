...
@Component({
  selector: 'app-list-hitos',
  templateUrl: './list-hitos.component.html',
  styleUrls: ['./list-hitos.component.scss']
})
export class ListHitosComponent  implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListHitosComponent>, private usrServ: UsuarioService,
