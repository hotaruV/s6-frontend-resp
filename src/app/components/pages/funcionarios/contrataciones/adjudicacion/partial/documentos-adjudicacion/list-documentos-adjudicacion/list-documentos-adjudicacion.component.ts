...
@Component({
  selector: 'app-list-documentos-adjudicacion',
  templateUrl: './list-documentos-adjudicacion.component.html',
  styleUrls: ['./list-documentos-adjudicacion.component.scss']
})
export class ListDocumentosAdjudicacionComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListDocumentosAdjudicacionComponent>, private usrServ: UsuarioService,
