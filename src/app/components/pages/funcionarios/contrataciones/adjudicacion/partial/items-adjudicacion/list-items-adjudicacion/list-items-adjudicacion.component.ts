...
@Component({
  selector: 'app-list-items-adjudicacion',
  templateUrl: './list-items-adjudicacion.component.html',
  styleUrls: ['./list-items-adjudicacion.component.scss']
})
export class ListItemsAdjudicacionComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListItemsAdjudicacionComponent>, private usrServ: UsuarioService,
