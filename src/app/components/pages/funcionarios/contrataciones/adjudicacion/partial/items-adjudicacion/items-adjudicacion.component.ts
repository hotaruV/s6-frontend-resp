...
import { ListItemsAdjudicacionComponent } from './list-items-adjudicacion/list-items-adjudicacion.component';
...
@Component({
  selector: 'app-items-adjudicacion',
  templateUrl: './items-adjudicacion.component.html',
  styleUrls: ['./items-adjudicacion.component.scss']
})
export class ItemsAdjudicacionComponent implements OnInit {
...
*/
  ...
  Vercot(): void {
    ...
    const dialogRef = this._modelService.open(ListItemsAdjudicacionComponent, {
      disableClose: true,
      autoFocus: true,
      width: '100%',
      height: '80%',
