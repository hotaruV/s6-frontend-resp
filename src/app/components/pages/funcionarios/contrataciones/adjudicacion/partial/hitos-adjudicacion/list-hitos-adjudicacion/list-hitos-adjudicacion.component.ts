...
@Component({
  selector: 'app-list-hitos-adjudicacion',
  templateUrl: './list-hitos-adjudicacion.component.html',
  styleUrls: ['./list-hitos-adjudicacion.component.scss']
})
export class ListHitosAdjudicacionComponent implements OnInit {
  ...
  constructor( public dialog: MatDialogRef<ListHitosAdjudicacionComponent>, private usrServ: UsuarioService,
